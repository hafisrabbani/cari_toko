...
function addCadreEurosFrancs($hrg_satuan, $hrg_total)
{
	$r1  = $this->w - 200;
	$r2  = $r1 + 190;
	...
	$this->Line( $r1+52,  $y1, $r1+52, $y2); // Entre Euros & Francs tengah
	...
	$this->SetXY( $r1, $y1+5 );
	$this->Cell(55,-4, "Mengetahui", 0, 0, "C");
	$this->SetXY( $r1, $y1+10 );
	$this->Cell(55,-6, "PT. PELANGI LINTAS SEJAHTERA ", 0, 0, "C");
	$this->SetXY( $r1, $y1+15 );
...
function addReglement( $mode )
{
	...
	$this->SetFont( "Arial", "B", 15);
	$this->Cell(31,50, "Laporan Pengeluaran", 0, 0, "R");
