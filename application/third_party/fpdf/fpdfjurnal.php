...
function addCadreEurosFrancs($hrg_satuan, $ppn, $hrg_total, $catatan)
{
	...
	#$this->SetFont( "Arial", "B", 6);
	$this->SetXY( $r1, $y1+5 );
	$this->Cell(15,-25, "                                                                                                                                                          Gresik, tgl ", 0, 0, "L");
	$this->Cell(60,-10, "Pemohon ", 0, 0, "L");
	$this->Cell(65,-10, "Di Setujui", 0, 0, "L");
	$this->Cell(50,-10, "Mengetahui ", 0, 0, "L");
	
	$this->SetFont( "Arial", "", 9);
	$this->SetXY( $r1+20, $y1 );
	$this->SetXY( $r1, $y1+25 );
	$this->Cell(60,-10, "                --------------         ", 0, 0, "L");
	$this->Cell(65,-10, "                     Kelik", 0, 0, "L");
	$this->Cell(50,-10, "                Hari Santoso ", 0, 0, "L");
...
function addNumTVA($tva, $nmMitra, $noInvoice, $noSpk, $alamat, $tglSpk)
{
	...
	$this->Cell(10, 50, "Alamat : ".$alamat, 0, 0, "L");
