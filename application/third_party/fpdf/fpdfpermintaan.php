...
function addCadreEurosFrancs($hrg_satuan, $ppn, $hrg_total, $catatan)
{
	...
	$this->Line( $r1+51, $y1+245, $r2+24, $y1+245); // Sous Euros & Francs
	$r1  = $this->w - 200;
	$r2  = $r1 + 190;
	$y1  = $this->h - 80;
	$y2  = $y1+37;
	...
	$this->SetXY( $r1, $y1+5 );
	$this->Cell(55,-2, "Mengetahui", 0, 0, "C");
	$this->SetXY( $r1, $y1+10 );
	$this->Cell(55,-1, "PT. PELANGI LINTAS SEJAHTERA ", 0, 0, "C");
	$this->SetXY( $r1, $y1+15 );
	$this->Cell(55,23, "HARI SANTOSO.S.E", 0, 0, "C");
	$this->SetXY( $r1, $y1+15 );
	$this->Cell(55,30, "DIREKTUR", 0, 0, "C");
	$this->SetXY( $r1, $y1+15 );
...
function addReglement( $mode )
{
	...
	$this->Cell(30,50, "Laporan Permintaan", 0, 0, "R");
