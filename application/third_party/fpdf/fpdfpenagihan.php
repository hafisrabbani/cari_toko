...
function addCadreEurosFrancs($hrg_satuan, $ppn, $hrg_total)
{
	$r1  = $this->w - 200;
	$r2  = $r1 + 190;
	...
	$this->Line( $r1+160, $y1+7, $r2, $y1+7); // Sous Euros & Francs
	$this->Line( $r1+160, $y1+14, $r2, $y1+14); // Sous Euros & Francs
	$this->Line( $r1+160, $y1+21, $r2, $y1+21); // Sous Euros & Francs
	$this->Line( $r1+160,  $y1, $r1+160, $y2); // Entre Euros & Francs
	$this->Line( $r1+130,  $y1, $r1+130 , $y2); // Entre Euros & Francs
	...
	#$this->SetFont( "Arial", "B", 6);
	$this->SetXY( $r1, $y1+5 );
	$this->Cell(280,-2, "Sub Total", 0, 0, "C");
	$this->SetXY( $r1, $y1+4 );
	$this->Cell(340.5, 0, "Rp. 4.000.000", 0, 0, "C");
	$this->SetXY( $r1, $y1+10 );
	$this->Cell(280,1, "PPN 10%", 0, 0, "C");
	$this->SetXY( $r1, $y1+11 );
	$this->Cell(338.5, 0, "Rp. 400.000", 0, 0, "C");
	$this->SetXY( $r1, $y1+15 );
	$this->Cell(288.5, 4, "GRAND TOTAL", 0, 0, "C");
	$this->SetXY( $r1, $y1+18 );
	$this->Cell(340.5, 0, "Rp. 4.400.000", 0, 0, "C");
	...
	$this->SetXY( $r1, $y1+5 );
	$this->Cell(75,6, "Nama Bank                       : Bank Negara Indonesia", 0, 0, "C");
	$this->SetXY( $r1, $y1+5 ); 
	$this->Cell(63,20, "No Rekening                     : 1111-2652-134", 0, 0, "C");
	$this->SetXY( $r1, $y1+5 );
	$this->Cell(90,32, "Pemilik Rekening             : PT. PELANGI LINTAS SEJAHTERA", 0, 0, "C");
...
function addReglement( $mode )
{
	...
	$this->RoundedRect($r1, $y1, ($r2 - $r1), 0, 'D');
	$this->RoundedRect($r1, $y1, ($r2 - $r1), 1, 'D');
	//$this->Line( $r1+105, $y1+96, $r2-165, $y1+96); // Sous Euros & Francs
	//$this->Line( $r1+30, $y1+207, $r2-180, $y1+207); // Sous Euros & Francs
	
	
	$this->Line( $r1, $mid, $r2, $mid);
	$this->SetXY( $r1 + ($r2-$r1)/2 -5 , $y1+1 );
	$this->SetFont( "Arial", "B", 8);
	$this->Cell(15,60, "", 0, 0, "R");
...
function addNumTVA($tva)
{
	...
	$this->Cell(10, 4, "PT. Pembangkit Jawa Bali", 0, 0, "L");
