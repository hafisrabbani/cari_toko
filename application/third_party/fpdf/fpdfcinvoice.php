...
function addCadreEurosFrancs($hrg_satuan, $hrg_total, $hrg_satuann, $hrg_totaln)
{
	$r1  = $this->w - 200;
	$r2  = $r1 + 190;
	...
	$this->Line( $r1+60,  $y1, $r1+60, $y2); // Entre Euros & Francs tengah
	...
	$this->Line( $r1+0, $y1+11, $r2, $y1+11); // Sous Euros & Francs

	$this->Line( $r1+14, $y1+45, $r2-149, $y1+45); // Sous Euros & Francs
	...
	$this->SetXY( $r1, $y1+7 );
	$this->SetFont( "Arial", "B", 11);
	$this->Cell(40,-2, "Total Invoice", 0, 0, "L");
	$this->SetXY( $r1, $y1+7 );
	$this->SetFont( "Arial", "B", 11);
	...
	$this->Cell(40,-2, "Kekurangan", 0, 0, "L");
	$this->SetXY( $r1, $y1+15 );
	$this->SetFont( "Arial", "B", 11);
	$this->Cell(0, 0, "Rp. ".str_replace(",",".", number_format($hrg_satuann)), 0, 0, "R");
	...
	$this->SetXY( $r1, $y1+10 );
	$this->Cell(55,-7, "PT. PELANGI LINTAS SEJAHTERA ", 0, 0, "C");
	$this->SetXY( $r1, $y1+15 );
	$this->Cell(55,16, "HARI SANTOSO.S.E", 0, 0, "C");
	$this->SetXY( $r1, $y1+15 );
	$this->Cell(55,22, "DIREKTUR", 0, 0, "C");
	$this->SetXY( $r1, $y1+15 );
...
function addReglement( $mode )
{
	...
	$mid = $y1 + (($y2-$y1));
	$this->RoundedRect($r1, $y1, ($r2 - $r1), 35, 'D');
	$this->Line( $r1, $mid, $r2, $mid);
	$this->SetXY( $r1 + ($r2-$r1)/2 -5 , $y1+1 );
	$this->SetFont( "Arial", "B", 15);
	$this->Cell(20,50, "Laporan Invoice", 0, 0, "R");
