...
<div class="wrapper wrapper-content animated fadeIn">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form action="<?php echo base_url('olshop/update_shop/').$this->session->userdata('id_user') ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
        ...
        <?php } else { ?>
                <img src="<?php echo base_url('assets/images/no_image.jpg') ?>" id="imgId" class="img-thumbnail" width="50%" alt="profile">
                <div>
                    <span><?php echo $total_produk->jumlah ?> Produk</span> |
                    <span>350 Terjual</span> |
                    <!-- <span>610 Followers</span> -->
        ...
        <div class="col-lg-6">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form action="<?php echo base_url('olshop/add_shop')?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Nama Toko</label>
                            <div class="col-sm-10">
                                <input type="hidden" name="created_at" value="<?php echo date('d/m/Y')?>">
                                <input type="hidden" name="id_user" value="<?php echo $this->session->userdata('id_user'); ?>">
                                <input type="text" name="olshop_name" class="form-control" placeholder="Nama Toko" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Gambar</label>
                            <div class="col-sm-10">
                                <input type="file" name="olshop_image" id="olshop_image" class="form-control" onchange="readURL(this)">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Provinsi</label>
                            <div class="col-sm-10">
                                <select name="province_id" class="form-control select2" id="p_id" onchange="loadCity()">
                                    <option value="">Pilih Provinsi</option>
                                    <?php
                                        foreach ($province as $p) {
                                            echo '<option value="'.$p->province_id.'">'.$p->nama_provinsi.'</option>';
                                        }
                                    ?>
                                </select>
                            </div>
